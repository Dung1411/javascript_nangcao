            ...
            <div class="flex flex-no-wrap">x    
                    ...
                    <ul class="py-6">
                        ...
                        <li class="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                            <div class="flex items-center">
                                ...
                                <a href="/admin/user" data-navigo class="ml-2">Users</a>
                            </div>
                        </li>
                ...
                <div class="w-full">
                    ...
                    <div class="bg-white dark:bg-gray-800  shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-y-auto">
                        ...
                        <h2 class="text-3xl p-5">Thêm Mới Sách</h2>
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-8 mb-5">
                            <a class="flex text-white" href="/#/admin/books"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div id="form-add" class="px-4 py-6 sm:px-0">
                                <div class=" bg-white rounded-md max-w-2xl">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" placeholder="price" id="category_id" class=" mt-2 outline-none py-1 px-2 text-md border-2 rounded-md w-full" />
                                    </div>
