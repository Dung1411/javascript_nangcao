                    ...
                    ${data.map((item) =>
                              `
                                <div tabindex="0" class="focus:outline-none mx-2 w-72 xl:mb-0 mb-8">
                                    <div>
                                        <img alt="girl texting" src="${item.img}" class="focus:outline-none w-full h-44" />
                                    </div>
                                    <div class="bg-white dark:bg-gray-800">
                                        ...
                                        <div class="p-4">
                                            <div class="flex items-center">
                                                <h2 tabindex="0" class="focus:outline-none text-lg dark:text-white font-semibold">${item.name}</h2>
                                            ...
                                            <div class="flex items-center justify-between py-4">
                                                ...
                                                <h3 tabindex="0" class="focus:outline-none text-indigo-700 text-xl font-semibold">${item.price}</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
